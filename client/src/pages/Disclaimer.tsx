  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-2xl mx-auto prose prose-invert">
        ...
        <p>
          While Wasabi AI strives to provide accurate and up-to-date information about
        ...
        <p>
          Information provided by Wasabi AI should not be considered financial advice.
        ...
        <p>
          ...
          and documentation. Wasabi AI is an educational tool, not a substitute for
