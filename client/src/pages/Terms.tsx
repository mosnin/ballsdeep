  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-2xl mx-auto prose prose-invert">
        ...
        <p>
          By accessing and using Shevoki, you agree to be bound by these Terms of Service.
        </p>

        <h2>2. Description of Service</h2>
        <p>
          Shevoki is an AI-powered educational chatbot focused on providing information about
        ...
        <p>
          Shevoki provides educational content but is not financial advice. Users are
